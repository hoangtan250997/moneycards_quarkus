...
public class SkillResource {
    ...
    public Response getActiveList(@Parameter(description = "Page number", required = true, name = "page") @QueryParam("page") int page,
                                  @Parameter(description = "Page size", required = true, name = "size") @QueryParam("size") int size
